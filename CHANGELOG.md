...
- **56 blocos** no plugue do catálogo, todos em grupo, todos desenhando com os próprios defaults;
- **paleta como INSTÂNCIA** do tipo do pai, com ~51 papéis derivados. O filho fornece a paleta e mais nada
  obrigatório;
- **99 testes** no DS, **40** no catálogo, analyzer limpo. Conformidade do pai com baseline vazia no DS e
...
- pais: `ds-diletta` **v0.21.1** · `catalogo-diletta` **v0.48.0**.
