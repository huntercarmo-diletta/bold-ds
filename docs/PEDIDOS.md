...
| [o trilho da barra é claro nos dois temas](pedidos/2026-08-10-o-trilho-da-barra-e-claro-nos-dois-temas.md) | **aberto** — o trilho como PAPEL, não degrau fixo. É a deixa do veredito do `tone`, medida: na minha paleta o `warning` dá **1,22 no claro e 1,04 no escuro** contra o trilho — pior que a referência dele (1,82/1,17). **1,04 não é abaixo do piso, é a mesma luminância**: a barra existe e não se vê, no modo que é o default deste app. E a inversão prova a causa: clarear o trilho não resolve (1,65), escurecer dá **6,08–9,76** com a MESMA tinta | — |
