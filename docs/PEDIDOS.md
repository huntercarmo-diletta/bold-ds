...
| [o degrau fixo não viaja entre paletas](pedidos/2026-08-10-o-degrau-fixo-nao-viaja-entre-paletas.md) | **aberto** — derivar o papel gráfico por CONTRASTE e não por degrau. Ele escreveu *"contraste não se herda de outra paleta"* e aplicou na MEDIÇÃO, não na derivação: `warningGrafico = warning03` dá **4,80 na referência e 2,85 aqui**. Vai com alvo medido — `warning02` fecha em 5,54, `primary03` em 6,79, e no escuro `neutral01` em 1,72 contra a página. E o `normal` reprovou sem ter papel gráfico | — |
| [o esqueleto pesa o dobro no escuro](pedidos/2026-08-10-o-esqueleto-pesa-o-dobro-no-escuro.md) | **aberto** — `surfaceLoading` como tinta com alpha, não degrau. Ele ADAPTA (um degrau por tema) e adapta pro lado errado: **claro 1,41 · escuro 2,51 — o escuro pesa 1,8×**. No claro o esqueleto é um vulto; no escuro é um bloco que chama atenção, que é o oposto do gesto. Alvo medido: **a tinta da superfície a ~14%** dá o mesmo peso dos dois lados. **É o SEGUNDO caso da classe do pedido acima** — lá degrau não viaja entre PALETAS, aqui não viaja entre TEMAS; nos dois o que se quis dizer era uma DISTÂNCIA | — |
