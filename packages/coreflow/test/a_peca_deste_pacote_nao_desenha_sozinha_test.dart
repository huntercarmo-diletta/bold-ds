...
/// varriam `lib/design_system/` do app. Em 01/09 essa pasta deixou de existir: as 40 peças foram
/// pro primeiro filho, e em 08/09 as que não dependem de produto vieram pra cá — com o gate junto.
///
...
void main() {
  ...
  test('a cor de um widget vem do tema — nem `Colors.*`, nem hex', () {
    cobraZero('cor do Material dentro do pacote', RegExp(r'(?<![\w.])Colors\.\w+'),
        'O avô declara os absolutos em `DilettaAbsoluteColors`; os papéis vêm do esquema em contexto.');
