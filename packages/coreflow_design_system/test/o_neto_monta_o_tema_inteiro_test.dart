...
///
/// O gate vizinho (`o_neto_troca_a_paleta_e_pronto`) mede 35 papéis do [CoreflowScheme] viajando com
...
///
/// A porta era `_monta`, privada. [CoreflowScheme.de] aceita paleta desde a v0.55.0 e não havia nada
/// acima dele que aceitasse: um produto novo montava o esquema com a paleta dele e não conseguia
/// registrá-lo. Desde 20/08 quem responde é o [CoreflowProduto], e este gate mede o que sai dele.
void main() {
  ...
  test('e os dois temas do neto saem da paleta DELE, não de duas paletas diferentes', () {
    // A invariante que o `///` do CoreflowTemaMaterial declarava em prosa: o par claro/escuro sai do
  ...
  test('o GRADIENTE do neto é o dele — a curva do símbolo não serve duas marcas', () {
    final curvaDele = const CoreflowGradients(
      paleta: DilettaPalette.referencia,
