...
void main() {
  Future<String> fundoResolvido(
    WidgetTester tester, {
    CoreflowBackdrop? escolhido,
    CoreflowBackdrop? daTela,
  }) async {
      ...
      DilettaThemeScope(
        ...
        child: Directionality(
          ...
          child: CoreflowBackdropScope(
            estilo: escolhido,
            child: CoreflowBackground(estilo: daTela, child: const SizedBox()),
          ),
        ),
      ),
    );
  ...
  testWidgets('sem escolha salva, o default da tela vale', (t) async {
    expect(await fundoResolvido(t, daTela: CoreflowBackdrop.solido), 'solido');
  });
  ...
  testWidgets('com escolha salva, ela VENCE o default da tela', (t) async {
    ...
    expect(
      await fundoResolvido(
        t,
        escolhido: CoreflowBackdrop.aurora,
        daTela: CoreflowBackdrop.solido,
      ),
      'aurora',
    );
  });
    ...
    await t.pumpWidget(
      DilettaThemeScope(
        ...
        child: const Directionality(
          textDirection: TextDirection.ltr,
          child: CoreflowBackdropScope(
            estilo: CoreflowBackdrop.aurora,
            child: CoreflowBackground.fixo(
              estilo: CoreflowBackdrop.porDoSol,
              child: SizedBox(),
            ),
          ),
        ),
