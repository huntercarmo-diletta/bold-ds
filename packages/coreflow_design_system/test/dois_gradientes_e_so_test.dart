...
void main() {
  test('a marca tem exatamente DOIS gradientes', () {
    expect(ContaBold.gradientes.todos.keys, ['primary', 'accent'],
  ...
  test('o primary parte da cor de AÇÃO; o accent vive na rampa de laranja', () {
    ...
    expect(ContaBold.gradientes.primary.colors.first, BoldPalette.bold.primary04);
    expect(ContaBold.gradientes.accent.colors,
  ...
  test('o primary é o LOCKUP de OITO paradas, com os offsets do arquivo', () {
    ...
    expect(ContaBold.gradientes.primary.colors, [
    ...
    expect(ContaBold.gradientes.primary.stops, BoldColors.lockupStops,
    ...
    expect(ContaBold.gradientes.accent.colors, [p.warning03, p.warning02]);
  });
  ...
  test('ZERO literal SOLTO: toda parada é degrau de rampa ou cor de marca DECLARADA', () {
    ...
    for (final g in ContaBold.gradientes.todos.entries) {
  ...
  test('a TINTA do gradiente é julgada no pior caso, e ela ganhou de branco e de preto', () {
    ...
    expect(ContaBold.gradientes.onGradient, BoldVinho.ink);
    ...
    final piorNoPrimary = pior(ContaBold.gradientes.onGradient, ContaBold.gradientes.primary);
    ...
    expect(piorNoPrimary, greaterThan(pior(BoldPalette.bold.white, ContaBold.gradientes.primary)));
    expect(pior(BoldPalette.bold.white, ContaBold.gradientes.primary), closeTo(1.21, 0.02),
    ...
    expect(pior(BoldPalette.bold.white, ContaBold.gradientes.accent), greaterThanOrEqualTo(3.0));
  });
}
