...
/// `CoreflowSegmentos` que eu disse ser de 22px num telefone de 390 foi medido na fonte quadrada. O defeito era
...
/// 2. **o nome da família importa**: `Inter` cru e `packages/coreflow_design_system/Inter` são duas
