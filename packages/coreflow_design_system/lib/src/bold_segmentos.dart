/// CONTA BOLD — os SEGMENTOS, e por que eles não são as [CoreflowAbas].
///
...
///
/// Este componente e as `CoreflowAbas` têm a MESMA API (`List<String>` + índice + `aoTrocar`), e a
...
class CoreflowSegmentos extends StatelessWidget {
  const CoreflowSegmentos({
    super.key,
