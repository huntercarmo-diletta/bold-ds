...
///
/// **`CoreflowType.tileLabel` (10/12) virou `DilettaType.labelSm` (11/16).** O grau de 10px não existe
...
class CoreflowLadrilhoDeMenu extends StatelessWidget {
  const CoreflowLadrilhoDeMenu({
    super.key,
    required this.icone,
    required this.rotulo,
    this.aoTocar,
    this.porte = CoreflowPorteDoLadrilho.largo,
  });
  ...
  final CoreflowPorteDoLadrilho porte;

  @override
  Widget build(BuildContext context) {
    final s = DilettaTheme.schemeOf(context);
    final compacto = porte == CoreflowPorteDoLadrilho.compacto;
    ...
    final respiro = switch (porte) {
      ...
      CoreflowPorteDoLadrilho.compacto => EdgeInsets.all(DilettaSpacing.s2),
      CoreflowPorteDoLadrilho.largo => EdgeInsets.all(DilettaSpacing.s4),
      CoreflowPorteDoLadrilho.alto => EdgeInsets.symmetric(
    ...
    final vao = porte == CoreflowPorteDoLadrilho.largo ? DilettaSpacing.s3 : DilettaSpacing.s2;
      ...
      child: DilettaGlassSurface(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            mainAxisAlignment: porte == CoreflowPorteDoLadrilho.alto
    ...
    return switch (porte) {
      ...
      CoreflowPorteDoLadrilho.compacto => SizedBox(height: 80, child: ladrilho),
      CoreflowPorteDoLadrilho.largo => SizedBox(height: 82, child: ladrilho),
      CoreflowPorteDoLadrilho.alto => SizedBox(height: 100, child: ladrilho),
    };
  }
}
