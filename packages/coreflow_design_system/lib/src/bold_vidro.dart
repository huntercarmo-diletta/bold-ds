...
/// folha leem daqui. A exceção tem nome e razão: [CoreflowVidroDeEntrada].
abstract final class CoreflowVidro {
  const CoreflowVidro._();
...
///
/// [CoreflowVidro] é o vidro do app: fill chapado sobre o backdrop. Este aqui fica sobre uma FOTO de
...
abstract final class CoreflowVidroDeEntrada {
  const CoreflowVidroDeEntrada._();
