...
/// desenha sobre a arte é o `CoreflowBackground`, e no escuro `primary` já contrasta.
///
...
/// — mesma decisão do sublinhado das `CoreflowAbas`.
library;
...
class CoreflowPontosDePagina extends StatelessWidget {
  const CoreflowPontosDePagina({
    super.key,
    required this.total,
