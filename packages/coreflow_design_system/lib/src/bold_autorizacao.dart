...
///
/// - [CoreflowProgressoDeAprovacao] responde a primeira: as assinaturas colhidas viram FORMA, não só
///   texto, pra dar pra ler de relance numa lista;
/// - [CoreflowPrazoDaPendencia] responde a segunda, e é quase só REGRA: os pixels são a etiqueta de status
///   do pai.
///
...
class CoreflowProgressoDeAprovacao extends StatelessWidget {
  const CoreflowProgressoDeAprovacao({
    super.key,
...
class CoreflowPrazoDaPendencia extends StatelessWidget {
  const CoreflowPrazoDaPendencia({
    super.key,
    this.restante,
    this.idade,
