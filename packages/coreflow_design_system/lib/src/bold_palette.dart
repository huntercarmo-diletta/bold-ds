...
class BoldColors {
  ...
  //
  // Eles estavam cravados dentro do `CoreflowScheme`, que é o pior lugar: um neto que trocasse a paleta
...
class BoldPalette {
  ...
  static const DilettaPalette bold = DilettaPalette(
    ...
    //
    // Estavam cravados dentro do `CoreflowScheme`, onde paleta nenhuma alcança. Como extras, eles entram
