...
/// `CoreflowBackground` recebe a arte pelo `CoreflowBackdropScope` — decisão certa do DS, que assim não crava
...
void main() {
  ...
  testWidgets('o gancho do frame DECLARA a arte, nos dois modos', (t) async {
    // Pelo gancho e não por um `CoreflowBackdropScope` que eu montasse no teste: o que precisa estar certo é
        ...
        child: Builder(
          builder: (ctx) => Builder(
            builder: (dentro) {
              ...
              scope = w is CoreflowBackdropScope ? w : null;
    ...
    expect(scope!.estilo, CoreflowBackdrop.imagem,
