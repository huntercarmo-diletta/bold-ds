# Norte Benk — um produto do Coreflow
...
MaterialApp(
  theme: norteBenk.materialClaro,
  darkTheme: norteBenk.materialEscuro,
  builder: (_, filho) => DilettaThemeScope(theme: norteBenk.claro, child: filho!),
);
```
...
| decisão | onde |
|---|---|
| o logo e o mapa da arte | `marcaVisual:` no `norte_benk.dart` |
| a família tipográfica e os degraus da escala | `tipografia:` no `norte_benk.dart` (`CoreflowTipografia`) |
