...
void main() {
  test('a marca está declarada, e o arquivo diz o que pode ser tingido', () {
    expect(BoldTheme.marca.pacote, 'conta_bold_design_system');
    expect(BoldTheme.marca.logoTingePorCurrentColor, isTrue,
    ...
    expect(BoldTheme.light.brand, BoldTheme.marca);
    expect(BoldTheme.dark.brand, BoldTheme.marca);
  });
  ...
  test('o arquivo tem as letras em currentColor e o gradiente intacto', () async {
    ...
    final svg = await rootBundleDoTeste(
        'packages/conta_bold_design_system/assets/logos/conta-bold-lockup.svg');
  ...
  test('e o mapa da ARTE é hex → NOME de degrau, não hex → cor', () {
    ...
    final mapa = BoldTheme.marca.hexesDaArte;
