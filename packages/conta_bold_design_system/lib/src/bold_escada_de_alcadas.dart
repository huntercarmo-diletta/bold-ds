...
/// uma linha por ponto de uso, e são dois. Quem quer o formatador tem o `BoldDinheiro` aqui do lado.
library;
...
class BoldDegrauDeAlcada {
  const BoldDegrauDeAlcada({
    this.ate,
...
class BoldEscadaDeAlcadas extends StatelessWidget {
  const BoldEscadaDeAlcadas({
    super.key,
    required this.degraus,
    this.densa = false,
  });

  final List<BoldDegrauDeAlcada> degraus;
...
class _Degrau extends StatelessWidget {
  ...
  final BoldDegrauDeAlcada degrau;
