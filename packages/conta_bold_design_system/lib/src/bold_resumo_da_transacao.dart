...
class BoldResumoDaTransacao extends StatelessWidget {
  const BoldResumoDaTransacao({
    super.key,
    required this.titulo,
    required this.valor,
    required this.quando,
    this.estado = BoldEstadoDaTransacao.concluida,
  });
  ...
  final BoldEstadoDaTransacao estado;
