...
///
/// Mesma classe de dívida do [BoldCartaoDaConta]: **widget privado que a tela constrói é invisível
...
///
/// `BoldProgressoDeAprovacao`, `BoldPrazoDaPendencia` e o botão do pai. Nenhuma das três nasceu
...
class BoldCartaoDePedido extends StatelessWidget {
  const BoldCartaoDePedido({
    super.key,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Flexible(
                  child: BoldProgressoDeAprovacao(
                      colhidas: colhidas,
                      exigidas: exigidas,
                ...
                if (idade != null) ...[
                  DilettaGap.w(DilettaSpacing.s2),
                  BoldPrazoDaPendencia(idade: idade),
                ],
              ],
            ),
            if (aprovadaPor != null) ...[
