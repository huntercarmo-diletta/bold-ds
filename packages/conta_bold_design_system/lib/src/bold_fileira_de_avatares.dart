...
///
/// O `BoldType.tileLabel` (10/12) do banco virou `DilettaType.labelSm`, mesma troca do ladrilho de
...
class BoldFileiraDeAvatares extends StatelessWidget {
  const BoldFileiraDeAvatares({
    super.key,
