...
/// Um item da [BoldNavFlutuante]: glifo do conjunto do pai + rótulo.
class BoldItemDeNav {
  const BoldItemDeNav({required this.icone, required this.rotulo});
...
class BoldNavFlutuante extends StatelessWidget {
  const BoldNavFlutuante({
    super.key,
    required this.itens,
    required this.ativo,
    this.aoTrocar,
  ...
  final List<BoldItemDeNav> itens;
