...
// BoldTabItem é palavra única do DS: mora no bold_bottom_app (usado por
// BoldBottomApp.nav). Aqui reusamos, não redefinimos (evita ambiguous_export).
import 'bold_bottom_app.dart' show BoldTabItem;
