...
/// ```
/// Os `typedef` abaixo são a superfície curta (`ds.X`); nomes longos `Bold*`
/// seguem válidos. Espelha o padrão do `cpf_seguro_design_system`.
library;
...
// AppSpacing, AppRadius, AppButton, appIcon, AtmosphericBackground…).
export 'ds_compat/conta_bold_theme.dart';

// ── Aliases curtos (ds.X) — gerados dos tipos públicos Bold* do DS real ───────
...
typedef DatePicker = BoldDatePicker;
