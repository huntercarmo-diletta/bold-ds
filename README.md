...
| pai | versão de hoje |
|---|---|
| `ds-diletta` | `v2.5.0` · `web-v2.5.0` |
| `catalogo-diletta` | `v0.117.0` |

## Como ESTE filho chega no app — `v0.118.0`

A primeira tag saiu em 2026-08-01; a de hoje é a `v0.118.0`. A entrega é a TAG, e isso não mudou. O que
